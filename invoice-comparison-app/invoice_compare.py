    ...
    # --- 1. CUSTOM CSS FOR MODERN "PILL" TABS AND BOUNCE ANIMATION ---
    def custom_tabs_style():
        """Applies a modern, segmented 'pill' style to the tabs and global custom CSS."""
        st.markdown("""
            <style>
            ...
            /* 2. Class to apply the animation and CENTERING container */
            .bounce-image-container {
                text-align: center; /* Centers the content (image) inside the container */
                margin: 20px 0;
            }
            
            .bounce-image {
                animation: bounce 2s infinite; /* Run the bounce animation, loop infinitely */
                display: inline-block; /* Essential for centering with text-align: center */
                max-width: 300px; /* Control image size */
                height: auto;
            }

            /* 3. Style the Tab Container (The gray bar holding the tabs) */
            ...
            /* 5. Style the Active (Selected) Tab */
            ...
            /* 6. Hide the default red line that Streamlit puts under tabs */
            .stTabs [data-baseweb="tab-border"] {
                display: none;
            }
            
            /* 7. Add spacing below the tabs */
            .stTabs {
                margin-bottom: 20px;
            }
            </style>
